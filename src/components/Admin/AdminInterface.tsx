 ...
 return (
  <div className="min-h-screen bg-gray-50 transition-colors duration-300">
   ...
   <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {tabs.map((tab) => {
       ...
       return (
        <button
         ...
         className={`flex items-center px-1 py-2 border-b-2 font-medium text-sm transition-colors duration-200 ${
          activeTab === tab.id
    ...
    {activeTab ==='overview' && (
     <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
       <div className="bg-white rounded-lg border border-gray-200 p-6 transition-colors duration-300">
    ...
    {activeTab ==='users' && (
     <div className="bg-white rounded-lg border border-gray-200 transition-colors duration-300">
