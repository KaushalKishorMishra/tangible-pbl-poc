     ...
     <div className="p-4 space-y-6">
            ...
            <div className="flex items-start justify-between mb-3">
             ...
             <div className="flex items-center space-x-2">
              <select
               ...
               className="px-2 py-1 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
              >
              ...
              <input
               ...
               className="w-16 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900"
              />
             </div>
            </div>
             ...
             {Object.entries(item.levels).map(([level, description]) => (
              <div
               ...
               className={`p-2 rounded text-sm ${
                assessment?.level === level ? getLevelColor(level) :'bg-gray-50 text-gray-700'
               }`}
              >
      ...
      <div>
       ...
       <textarea
        ...
        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-white text-gray-900 placeholder-gray-400"
        rows={4}
       />
      </div>
