...
export const GraphErrorState: React.FC<GraphErrorStateProps> = ({
	...
	return (
		<div className="flex flex-col items-center justify-center h-full p-10 text-center bg-linear-to-br from-slate-50 via-white to-indigo-50/30 animate-in fade-in duration-500">
			...
			<div className="mb-2 flex items-center justify-center gap-2">
                ...
                <span className="text-[10px] font-black text-rose-500 uppercase tracking-[0.3em]">System Interruption</span>
            </div>
			...
			<p className="text-slate-500 mb-10 max-w-md font-medium leading-relaxed opacity-80">
				{error || "We encountered an unexpected issue while designing your learning architecture. Our AI architects are standing by."}
			</p>
			<button
				onClick={onRetry}
