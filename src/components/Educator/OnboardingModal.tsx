...
const onboardingSteps = [
  ...
  },
  {
    ...
    content: "Skills are categorized by proficiency levels: Awareness (basic knowledge), Application (practical use), and Mastery (expert level).",
              ...
              <div className="text-center">
                <div className="bg-white rounded-lg shadow-sm p-4 inline-block">
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span className="text-sm">Application Level</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input type="checkbox" className="rounded" />
                      <span className="text-sm">Backend Category</span>
                    </div>
                  </div>
                </div>
