     ...
     {showAddModule && (
      <div className="space-y-3 mb-4 p-3 bg-gray-50 rounded-lg">
       <input
        ...
        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900 placeholder-gray-400"
       />
       <textarea
        ...
        <div className="mb-8">
         ...
         <div className="space-y-4">
          {generateRecommendedSimulations(selectedModuleData.skills).map(simulation => (
           <div key={simulation.id} className="bg-linear-to-r from-purple-50 to-blue-50 rounded-lg p-4 border border-purple-200">
            <div className="flex items-start justify-between">
             <div className="flex-1">
