...
export const LeftDrawer = () => {
    const { resetFilters, handleSelectNode } = useGraphStore();

    return (
        <div className="absolute top-0 left-0 bottom-0 w-80 h-full bg-white border-r border-gray-200 flex flex-col shadow-xl z-20">
            {/* Header */}
